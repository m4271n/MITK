...
mitk::USTerasonDevice::USTerasonDevice(std::string manufacturer, std::string model)
: mitk::USDevice(manufacturer, model),
//m_ControlsProbes(mitk::USTerasonProbesControls::New(this)),
//m_ControlsBMode(mitk::USTerasonBModeControls::New(this)),
//m_ControlsDoppler(mitk::USTerasonDopplerControls::New(this)),
m_ImageSource(mitk::USTerasonImageSource::New())/*, m_UsgMainInterface(0),
...
mitk::USTerasonDevice::~USTerasonDevice()
{
}

std::string mitk::USTerasonDevice::GetDeviceClass()
{
  return "org.mitk.modules.us.USTerasonDevice";
}

//mitk::USControlInterfaceBMode::Pointer mitk::USTerasonDevice::GetControlInterfaceBMode()
//{
//  return m_ControlsBMode.GetPointer();
//}
//
//mitk::USControlInterfaceProbes::Pointer mitk::USTerasonDevice::GetControlInterfaceProbes()
//{
//  return m_ControlsProbes.GetPointer();
//};
//
//mitk::USControlInterfaceDoppler::Pointer mitk::USTerasonDevice::GetControlInterfaceDoppler()
//{
//  return m_ControlsDoppler.GetPointer();
//};

bool mitk::USTerasonDevice::OnInitialization()
{
  //CoInitialize(NULL); // initialize COM library

   m_ImageSource->SetEngine(&m_USEngine);

  return true;
}

bool mitk::USTerasonDevice::OnConnection()
{
  //// create main Terason API COM library object
  //HRESULT hr;
  ...
  //  MITK_ERROR("USDevice")("USTerasonDevice") << "Error at connecting to ultrasound device (" << hr << ").";
  //  return false;
  //}
...
bool mitk::USTerasonDevice::OnDisconnection()
{
...
bool mitk::USTerasonDevice::OnActivation()
{
  ...
  //{
  //  MITK_WARN("USDevice")("USTerasonDevice") << "No probe found.";
  //  return false;
  //}
  ...
  //if (FAILED(hr))
  //{
  //  MITK_ERROR("USDevice")("USTerasonDevice") << "Could not set scan mode b (" << hr << ").";
  //  return false;
  //}
  ...
  //if (FAILED(hr))
  //{
  //  MITK_ERROR("USDevice")("USTerasonDevice") << "Start scanning failed (" << hr << ").";
  //  return false;
  //}
...
bool mitk::USTerasonDevice::OnDeactivation()
{
  //this->StopScanning();
  return true;
}

void mitk::USTerasonDevice::OnFreeze(bool freeze)
{
  if ( freeze )
  {
     m_USEngine.FreezeUltrasound();
    //m_UsgDataView->put_ScanState(Usgfw2Lib::SCAN_STATE_FREEZE);
  }
  else
  {
     m_USEngine.UnfreezeUltrasound();
    //m_UsgDataView->put_ScanState(Usgfw2Lib::SCAN_STATE_RUN);
  }
}

mitk::USImageSource::Pointer mitk::USTerasonDevice::GetUSImageSource()
{
  return m_ImageSource.GetPointer();
}

//void mitk::USTerasonDevice::ReleaseUsgControls()
//{
...
//void mitk::USTerasonDevice::StopScanning()
//{
//  if ( ! m_UsgDataView )
//  {
//    MITK_WARN("USDevice")("USTerasonDevice") << "Cannot stop scanning as Terason Data View is null.";
//    return;
//  }
//
//  HRESULT hr;
...
//  if (FAILED(hr))
//  {
//    MITK_ERROR("USDevice")("USTerasonDevice") << "Stop scanning failed (" << hr << ").";
//    mitkThrow() << "Stop scanning failed (" << hr << ").";
//  }
//}

//Usgfw2Lib::IUsgfw2* mitk::USTerasonDevice::GetUsgMainInterface()
//{
//  return m_UsgMainInterface;
//}
//
//void mitk::USTerasonDevice::SetActiveDataView(Usgfw2Lib::IUsgDataView* usgDataView)
//{
...
//}
//
//void mitk::USTerasonDevice::ConnectDeviceChangeSink( )
//{
...
// --- Methods for Terason API Interfaces

//HRESULT __stdcall mitk::USTerasonDevice::raw_OnBeamformerArrive(IUnknown *pUsgBeamformer, ULONG *reserved)
//{
//  this->Connect();
//
//  return S_OK;
//}
//
//HRESULT __stdcall mitk::USTerasonDevice::raw_OnBeamformerRemove(IUnknown *pUsgBeamformer, ULONG *reserved)
//{
...
//}
//
//HRESULT __stdcall mitk::USTerasonDevice::raw_OnProbeArrive(IUnknown*, ULONG* probeIndex)
//{
...
//};
//
//HRESULT __stdcall mitk::USTerasonDevice::raw_OnProbeRemove(IUnknown*, ULONG* probeIndex)
//{
...
//};
//
//STDMETHODIMP_(ULONG) mitk::USTerasonDevice::AddRef()
//{
//  ++m_RefCount;
//  return m_RefCount;
//}
//
//STDMETHODIMP_(ULONG) mitk::USTerasonDevice::Release()
//{
//  --m_RefCount;
//  return m_RefCount;
//}
//
//STDMETHODIMP  mitk::USTerasonDevice::QueryInterface(REFIID riid, void** ppv)
//{
...
//}
//
//HRESULT mitk::USTerasonDevice::GetTypeInfoCount(UINT *pctinfo)
//{
...
//}
//
//HRESULT mitk::USTerasonDevice::GetTypeInfo(UINT itinfo, LCID lcid, ITypeInfo** pptinfo)
//{
...
//}
//
//HRESULT mitk::USTerasonDevice::GetIDsOfNames(const IID &riid, LPOLESTR* rgszNames, UINT cNames, LCID lcid, DISPID* rgdispid)
//{
//  // this is not used - must use the same fixed dispid's from Usgfw2 idl file
//  return S_OK;
//}
//
//HRESULT mitk::USTerasonDevice::Invoke(DISPID dispIdMember, const IID &riid, LCID lcid, WORD wFlags, DISPPARAMS *pDispParams, VARIANT *pVarResult, EXCEPINFO *pExcepInfo, UINT *puArgErr)
//{
